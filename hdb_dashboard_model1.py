...
def map_to_nearest_mid(storey):
    """Map a storey number to the nearest mid value from training data."""
    return min(MID_VALUES, key=lambda x: abs(x - storey))
...
# Map storey input to nearest training mid value
mid = map_to_nearest_mid(storey)
